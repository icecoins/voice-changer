...
def setupArgParser():
    ...
    parser.add_argument("--host", type=str, default='0.0.0.0', help="IP address of the network interface to listen for HTTP connections. Specify 0.0.0.0 to listen on all interfaces.")
